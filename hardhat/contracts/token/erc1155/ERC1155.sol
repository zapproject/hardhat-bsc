    ...
    IERC1155MetadataURI
{
  ...
  */
        ...
        hasValidPermit(UNIVERSAL, SET_URI)
    {
        require(
            !uriLocked,
            "ERC1155: the collection URI has been permanently locked"
        );
  ...
  */
        ...
        hasValidPermit(UNIVERSAL, SET_URI)
    {
        require(
            !contractUriLocked,
            "ERC1155: the contract URI has been permanently locked"
        );
  ...
  */
    function configureGroup(
        ...
        require(_groupId != 0, "ERC1155: group ID 0 is invalid");
        require(
            _hasItemRight(_groupId, CONFIGURE_GROUP),
            "ERC1155: you don't have rights to configure group"
        );
        ...
        if (!itemGroups[_groupId].initialized) {
            require(
                !locked,
                "ERC1155: the collection is locked so groups cannot be created"
            );
            ...
            if (
                ...
                require(
                    ...
                    "ERC1155: you may not uncap a capped supply type"
                );
                require(
                    _data.supplyData <= itemGroups[_groupId].supplyData,
                    "ERC1155: you may not increase the supply of a capped type"
                );
            ...
            require(
                ...
                "ERC1155: you may not decrease supply below the circulating amount"
            );
            ...
            if (
                ...
                require(
                    ...
                    "ERC1155: you may not alter nonfungible items"
                );
                ...
                if (_data.itemType == DFStorage.ItemType.Nonfungible) {
                    require(
                        ...
                        "ERC1155: the fungible item is not unique enough to change"
                    );
        ...
        returns (uint256)
    {
        ...
        if (itemGroups[groupId].supplyType != DFStorage.SupplyType.Uncapped) {
            require(
                ...
                "ERC1155: you cannot mint a group beyond its cap"
            );
        }
        ...
        if (itemGroups[groupId].itemType == DFStorage.ItemType.Nonfungible) {
            require(
                ...
                "ERC1155: you cannot mint more than a single nonfungible item"
            );
            ...
            require(
                ...
                "ERC1155: you cannot mint more than the alloted semifungible items"
            );
        }
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            require(
                ...
                "ERC1155: you do not have the right to mint that item"
            );
  ...
  */
        ...
        returns (uint256)
    {
        ...
        require(
            itemGroups[groupId].initialized,
            "ERC1155: you cannot burn a non-existent item group"
        );

        // If the item group is non-burnable, then revert.
        if (itemGroups[groupId].burnType == DFStorage.BurnType.None) {
            revert("ERC1155: you cannot burn a non-burnable item group");
        }
        ...
        if (itemGroups[groupId].burnType == DFStorage.BurnType.Burnable) {
            require(
                ...
                "ERC1155: you may not exceed the burn limit on this item group"
            );
        }
    ...
    function burnBatch(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            require(
                ...
                "ERC1155: you do not have the right to burn that item"
            );
  ...
  */
    function burn(
        ...
        require(
            ...
            "ERC1155: you don't have rights to burn"
        );
  ...
  */
    function setMetadata(uint256 _id, string memory _metadata) external {
        require(
            ...
            "ERC1155: you don't have rights to setMetadata"
        );
        uint256 groupId = _id >> 128;
        require(
            !uriLocked && !metadataFrozen[_id] && !metadataFrozen[groupId],
            "ERC1155: you cannot edit this metadata because it is frozen"
        );
  ...
  */
    function lockURI(string calldata _uri, uint256 _id) external {
        require(
            ...
            "ERC1155: you don't have rights to lock URI"
        );
  ...
  */
    function lockGroupURI(string calldata _uri, uint256 groupId) external {
        require(
            ...
            "ERC1155: you don't have rights to lock group URI"
        );
