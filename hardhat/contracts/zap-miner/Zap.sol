...
contract Zap {
    ...
    function beginDispute(
        ...
        vault.withdraw(msg.sender, zap.uintVars[ZapConstants.getDisputeFee()]);
        vault.deposit(zap.addressVars[ZapConstants.get_owner()], zap.uintVars[ZapConstants.getDisputeFee()]);
