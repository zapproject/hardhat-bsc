...
interface ZapMarketOldInterface extends ethers.utils.Interface {
  functions: {
    ...
    "configure(address,address,bytes32,bytes32)": FunctionFragment;
...
export class ZapMarketOld extends Contract {
  ...
  interface: ZapMarketOldInterface;
  ...
  functions: {
    ...
    "configure(address,address,bytes32,bytes32)"(
      deployer: string,
      mediaContract: string,
      name: BytesLike,
      symbol: BytesLike,
    ...
    "setBidShares(uint256,((uint256),(uint256),address[],uint256[]))"(
      tokenId: BigNumberish,
      bidShares: {
        creator: { value: BigNumberish };
        owner: { value: BigNumberish };
