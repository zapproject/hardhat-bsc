...
interface CreatureLootBoxInterface extends ethers.utils.Interface {
  functions: {
    ...
    "itemsPerLootbox()": FunctionFragment;
...
export class CreatureLootBox extends Contract {
  ...
  functions: {
    ...
    itemsPerLootbox(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    unpack(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    itemsPerLootbox(overrides?: CallOverrides): Promise<PopulatedTransaction>;
