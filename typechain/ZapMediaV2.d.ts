...
interface ZapMediaV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "returnSuccess()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "returnSuccess",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ZapMediaV2 extends Contract {
  ...
  returnSuccess(overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    returnSuccess(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    returnSuccess(overrides?: CallOverrides): Promise<PopulatedTransaction>;
