...
import type { ZapTokenBSC } from "../ZapTokenBSC";

export class ZapTokenBSC__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<ZapTokenBSC>;
  }
  ...
  attach(address: string): ZapTokenBSC {
    return super.attach(address) as ZapTokenBSC;
  }
  connect(signer: Signer): ZapTokenBSC__factory {
    return super.connect(signer) as ZapTokenBSC__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ZapTokenBSC {
    return new Contract(address, _abi, signerOrProvider) as ZapTokenBSC;
  }
}
