...
describe('Database_Transactions', async () => {
    ...
    it('setStorageContract() - Fails if anyone but the owner runs the function'
        ...
        it('setBytes32() - Tests if a byte can be set in the DB'
        , async () => {
        ...
        it('setNumber() - Tests if a number can be set in the DB'
        , async () => {
        ...
        it('setBytes() - Tests if a byte can be set in the DB'
        , async () => {
        ...
        it('setIntArray() - Tests if an int array can be set in the DB'
        , async () => {
        ...
        it('setIntArrayIndex() - Tests if an int array can be overwritten in the DB'
        , async () => {
        ...
        it('setIntArrayIndex() - Tests if an int array fails when an out of bounds index is overwritten'
        , async () => {
        ...
        it('pushIntArray() - Tests if an int array can be pushed to in the DB'
        , async () => {
        ...
        it('setBytesArray() - Tests if an byte array can be set in the DB'
        , async () => {

            let input_byte_key : BytesLike = formatBytes32String("1")
            let input_byte_array: BytesLike[] = [formatBytes32String("a"),formatBytes32String("b")]
        ...
        it('setBytesArrayIndex() - Tests if an byte array can be overwritten in the DB'
        , async () => {
        ...
        it('setBytesArrayIndex() - Tests if an byte array fails when an out of bounds index is overwritten'
        , async () => {
        ...
        it('pushBytesArray() - Tests if an byte array can be pushed to in the DB'
        , async () => {

            let input_byte_key : BytesLike = formatBytes32String("1")
            let input_byte_array: BytesLike[] = [formatBytes32String("a")]
            let input_byte_val: BytesLike = formatBytes32String("b")
            let final_output_byte_array: BigNumberish[] = [formatBytes32String("a"),formatBytes32String("b")]
        ...
        it('setAddressArray() - Tests if an address array can be set in the DB'
        , async () => {
        ...
        it('setAddressArrayIndex() - Tests if an address array can be overwritten in the DB'
        , async () => {
            ...
            try {
                ...
                await db.setAddressArrayIndex(input_byte_key, test_index,input_address_val)
        ...
        it('setAddressArrayIndex() - Tests if an byte array fails when an out of bounds index is overwritten'
        , async () => {
        ...
        it('pushAddressArray() - Tests if an address array can be pushed to in the DB'
        , async () => {

            let input_byte_key : BytesLike = formatBytes32String("1")
            let input_address_array: string[] = [ethers.constants.AddressZero]
            let input_address_val: string = add1.address
            let final_output_address_array: string[] = [ethers.constants.AddressZero,add1.address]
