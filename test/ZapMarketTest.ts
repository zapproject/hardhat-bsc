...
describe('ZapMarket Test', () => {
  ...
  describe.only('#Configure', () => {
    ...
    beforeEach(async () => {
      ...
      // REMOVE ZAPMARKETV2 FOR NOW UNTIL TESTS ARE STABLE AFTER PLATFORM FEE
    ...
    it.skip('Should upgrade ZapMarket with the new getConfigStatus function and preserve the state', async () => {
    ...
    it.skip('Should revert if initialize is called twice', async () => {
  ...
  describe.only('#setBidShares', () => {
    ...
    it.skip('Should reject if the bid shares are invalid', async () => {
