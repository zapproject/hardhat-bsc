...
library ZapStake {
    ...
    function init(ZapStorage.ZapStorageStruct storage self) public {
        ...
        self.uintVars[keccak256('timeOfLastNewValue')] =
            now -
            (now % self.uintVars[keccak256('timeTarget')]);
     ...
     */
    function requestStakingWithdraw(ZapStorage.ZapStorageStruct storage self)
        public
    {
     ...
     */
    function newStake(ZapStorage.ZapStorageStruct storage self, address staker)
        internal
    {
     ...
     */
    function getNewCurrentVariables(ZapStorage.ZapStorageStruct storage self)
        internal
        view
        returns (
            bytes32 _challenge,
