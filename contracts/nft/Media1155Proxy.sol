...
/// @title Upgradeable proxy contract for a Media1155
/// @notice This contract acts as a proxy that delegates calls for Media1155.
///         it stores the Media1155 implementation address which can be upgraded by the admin
/// @dev Implements the OpenZeppelin ERC1967UpgradeUpgradeable contract
contract Media1155Proxy is ERC1967UpgradeUpgradeable {
    modifier onlyAdmin() {
        require(
    ...
    /// @notice Constructor for the Media1155 proxy and its implementation
    ...
    /// @param owner the intended owner of the Media1155 contract
    /// @param uri the token URI in standard to erc1155 tokens
    ...
    function initialize(
        ...
        _upgradeBeaconToAndCall(
            ...
            abi.encodeWithSignature(
                'initialize(string,address,bool,string)',
                uri,
                marketContractAddr,
                permissive,
                collectionURI
        ...
        require(
            ...
            'Creating Media1155 proxy: Can not transfer ownership of proxy'
        );
    }
    ...
    /// @notice Get the owner of the Media1155 implementation
    ...
    /// @return _implOwner address of this Media1155's owner
        ...
        returns (address _implOwner)
    {
        ...
        require(
            success && returndata.length > 0,
            'Can not get the owner of this Media1155'
        );
