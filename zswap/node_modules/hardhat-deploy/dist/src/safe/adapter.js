...
class SafeProviderAdapter {
    ...
    constructor(wrapped, signer, safe, serviceUrl) {
        ...
        this.createLibInterface = new abi_1.Interface(['function performCreate(uint256,bytes)']);
        this.safeInterface = new abi_1.Interface(['function nonce() view returns(uint256)']);
        this.wrapped = wrapped;
        this.signer = signer;
        this.safe = address_1.getAddress(safe);
        this.serviceUrl = serviceUrl !== null && serviceUrl !== void 0 ? serviceUrl : 'https://safe-transaction.rinkeby.gnosis.io';
        this.safeContract = new contracts_1.Contract(safe, this.safeInterface, this.signer);
    }
    ...
    async request(args) {
        ...
        if (args.method === 'eth_sendTransaction' &&
            args.params &&
            ((_a = args.params[0].from) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === this.safe.toLowerCase()) {
            ...
            const safeTxHash = hash_1._TypedDataEncoder.hash({ verifyingContract: this.safe }, execution_1.EIP712_SAFE_TX_TYPE, safeTx);
        ...
        if (args.method === 'eth_getTransactionReceipt') {
            ...
            if (safeTx === null || safeTx === void 0 ? void 0 : safeTx.transactionHash) {
                ...
                if (!resp)
                    return resp;
                const success = resp.logs.find((log) => log.topics[0] ===
                    '0x442e715f626346e8c54381002da614f62bee8d27386535b2521ec8540898556e');
                resp.status = success ? '0x1' : '0x0';
                if (safeTx.to.toLowerCase() === this.createLibAddress.toLowerCase()) {
                    const creationLog = resp.logs.find((log) => log.topics[0] ===
                        '0x4db17dd5e4732fb6da34a148104a592783ca119a1e7bb8829eba6cbadef0b511');
                    resp.contractAddress = address_1.getAddress('0x' + creationLog.data.slice(creationLog.data.length - 40));
                }
                return resp;
            }
        }
