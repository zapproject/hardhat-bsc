...
describe("MiniZswapDirectorV2", function () {
  before(async function () {
    await prepare(this, ["MiniZswapDirectorV2", "GZapToken", "ERC20Mock", "RewarderMock", "RewarderBrokenMock"])
  ...
  beforeEach(async function () {
    ...
    await deploy(this, [
      ...
      ["chef", this.MiniZswapDirectorV2, [this.gzap.address]],
    ...
    await this.gzap.mint(this.chef.address, getBigNumber(10000))
