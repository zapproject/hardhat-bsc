...
describe("ZswapWizard", function () {
  before(async function () {
    await prepare(this, ["ZswapWizard", "ZswapStake", "ZswapWizardExploitMock", "ERC20Mock", "UniswapV2Factory", "UniswapV2Pair"])
  })
  ...
  beforeEach(async function () {
    ...
    await deploy(this, [["ZswapWizard", this.ZswapWizard, [this.factory.address, this.bar.address, this.gzap.address, this.weth.address]]])
  ...
  describe("setBridge", function () {
    it("does not allow to set bridge for Sushi", async function () {
      await expect(this.ZswapWizard.setBridge(this.gzap.address, this.weth.address)).to.be.revertedWith("SushiMaker: Invalid bridge")
    })
