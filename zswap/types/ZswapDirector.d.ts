...
interface ZswapDirectorInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "gzap", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "gzap", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "massUpdatePools",
    data: BytesLike
  ): Result;
...
export class ZswapDirector extends Contract {
  ...
  interface: ZswapDirectorInterface;
  ...
  functions: {
    ...
    gzap(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    gzap(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    gzap(overrides?: CallOverrides): Promise<PopulatedTransaction>;
