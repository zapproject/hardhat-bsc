...
interface MiniZswapDirectorV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "gzapPerSecond()": FunctionFragment;
    ...
    "setGZapPerSecond(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "gzapPerSecond",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setGZapPerSecond",
    values: [BigNumberish]
  ): string;
  ...
  events: {
    ...
    "LogGZapPerSecond(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "LogGZapPerSecond"): EventFragment;
...
export class MiniZswapDirectorV2 extends Contract {
  ...
  interface: MiniZswapDirectorV2Interface;
  ...
  functions: {
    ...
    gzapPerSecond(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setGZapPerSecond(
      _gzapPerSecond: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setGZapPerSecond(uint256)"(
      _gzapPerSecond: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    LogGZapPerSecond(gzapPerSecond: null): EventFilter;
  ...
  populateTransaction: {
    ...
    gzapPerSecond(overrides?: CallOverrides): Promise<PopulatedTransaction>;
