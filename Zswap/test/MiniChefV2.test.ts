...
describe("MiniChefV2", function () {
  ...
  beforeEach(async function () {
    ...
    await deploy(this, [
      ...
      ["chef", this.MiniChefV2, [this.gzap.address]],
  ...
  describe("PendingG-Zap", function () {
    it("PendingG-Zap should equal ExpectedG-Zap", async function () {
      await this.chef.add(10, this.rlp.address, this.rewarder.address)
  ...
  describe("Harvest", function () {
    ...
    it("Harvest for G-Zap-only pool", async function () {
