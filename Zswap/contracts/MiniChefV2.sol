...
/// @notice The (older) ZapDirector contract gives out a constant number of G-Zap tokens per block.
...
contract MiniChefV2 is BoringOwnable, BoringBatchable {
    ...
    /// @notice Sets the G-Zap per second to be distributed. Can only be called by the owner.
    /// @param _sushiPerSecond The amount of G-Zap to be distributed per second.
    ...
    /// @notice Deposit LP tokens to ZDV2 for G-Zap  allocation.
    /// @param pid The index of the pool. See `poolInfo`.
