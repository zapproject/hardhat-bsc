...
// ZapShoot helps your migrate your existing Uniswap LP tokens to ZSwap LP ones
contract ZapMigrator {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'Z-Swap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'ZapMigrator: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'ZapMigrator: INSUFFICIENT_B_AMOUNT');
    }
